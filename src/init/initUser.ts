...
export const initUser: Record<string, IInitUser> = {
  admin: {
    id: 1,
    username: 'admin',
    avatar: `${QINIU_RESOURCE.url}/billd-desk/image/def9f85caeb1bf7602ae1bc37f00b03d.webp`,
  ...
  systemUser1: {
    ...
    avatar: `${QINIU_RESOURCE.url}/billd-desk/image/15a116a978cadb34e9fbf0061a4145bc.webp`,
    live_room: {
      id: 2,
      name: '房东的猫-云烟成雨',
      desc: '房东的猫livehouse合集',
  ...
  systemUser2: {
    id: 3,
    username: 'Dukoo',
    avatar: `${QINIU_RESOURCE.url}/billd-desk/image/752a40d44811c99278961410da656464.webp`,
  ...
  systemUser3: {
    id: 4,
    username: 'MoonTIT',
    avatar: `${QINIU_RESOURCE.url}/billd-desk/image/2b045c7f02febd23893244e923115535.webp`,
  ...
  systemUser4: {
    id: 5,
    username: 'Nill',
    avatar: `${QINIU_RESOURCE.url}/billd-desk/image/2142b19fe33e1fd7ed848104f64c4fd4.webp`,
    user_roles: [DEFAULT_ROLE_INFO.VIP_USER.id],
    live_room: {
      id: 5,
      name: '房东的猫-下一站茶山刘',
  ...
  systemUser5: {
    id: 6,
    username: 'Ojin',
    avatar: `${QINIU_RESOURCE.url}/billd-desk/image/7e048083bb5dccde76018625b644c84b.webp`,
    user_roles: [DEFAULT_ROLE_INFO.VIP_USER.id],
    live_room: {
      id: 6,
